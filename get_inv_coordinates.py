...
def get_inv_coordinates(
    sample: str, resolutions: list, thresholds: list, sweet_sizes: list
) -> pd.DataFrame:
    ...
    if len(res_pred_datas) > 0:
        ...
        logging.getLogger(__name__).info(sample + "don't have predictions")
        return data_rearr
